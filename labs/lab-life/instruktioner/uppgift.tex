...
Mer att läsa om ''Conway's Game of Life'' och fler exempel att prova finns på nätet. Använd t. ex. sökorden "Conway game of life".
	...
	\end{itemize}
        ...
        % Simple variations on the Game of Life rule (2 states, Moore neighborhood)
        \begin{itemize}
        ...
        % Other cellular automata with rules significantly different from Game of Life (≥2 states, not necessarily using the Moore neighborhood)
        \begin{itemize}
        ...
        % Might not be of direct interest, but idk
        \begin{itemize}
                \item \href{https://en.wikipedia.org/wiki/Spaceship_(cellular_automaton)}
